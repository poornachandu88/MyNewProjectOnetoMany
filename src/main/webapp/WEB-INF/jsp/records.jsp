...
<body>
	...
	<c:url var="editImgUrl" value="/resources/edit.png" />
	<c:url var="deleteImgUrl" value="/resources/delete.png" />
	<c:url var="addUrl" value="/addrecord" />
				...
				<c:if test="${!empty person.creditCards}">
					<c:forEach items="${person.creditCards}" var="creditCard">
						<tr>
							...
							<c:url var="editCcUrl"
								value="/creditcard/edit?pid=${person.id}&cid=${creditCard.id}" />
							<c:url var="deleteCcUrl"
								value="/creditcard/delete?id=${creditCard.id}" />
